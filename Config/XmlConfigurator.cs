...
namespace log4net.Config
{
    ...
    public sealed class XmlConfigurator
    {
		...
		/// </remarks>
#endif
        static public ICollection Configure(string connString = null)
        {
            Appender.AdoNetAppender.MyConnectionString = connString;
		...
		/// </remarks>
#endif
        static public ICollection Configure(FileInfo configFile, string connString = null)
        {
            Appender.AdoNetAppender.MyConnectionString = connString;
            ArrayList configurationMessages = new ArrayList();
